defmodule AntPressWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: AntPressWeb.Gettext
  ...
  def flash(assigns) do
    ...
    >
      <div class={[
        ...
        <div class="flex-1" />
        <button type="button" class="group self-start cursor-pointer" aria-label="閉じる">
  ...
  * `.label` が文字色を 60% の不透明度にする
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AntPressWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AntPressWeb.Gettext, "errors", msg, opts)
    end
  end
