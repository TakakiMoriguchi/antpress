defmodule AntPressWeb.UserAuth do
  ...
  @remember_me_cookie "_ant_press_web_user_remember_me"
  @remember_me_options [
    sign: true,
  ...
  def disconnect_sessions(tokens) do
    Enum.each(tokens, fn %{token: token} ->
      AntPressWeb.Endpoint.broadcast(user_session_topic(token), "disconnect", %{})
    end)
  end
  ...
  the `current_user`:
      ...
      defmodule AntPressWeb.PageLive do
        ...
        on_mount {AntPressWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{AntPressWeb.UserAuth, :require_authenticated}] do
