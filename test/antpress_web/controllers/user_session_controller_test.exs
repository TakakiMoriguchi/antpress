defmodule AntPressWeb.UserSessionControllerTest do
  ...
  describe "POST /client/log-in - email and password" do
    test "logs the user in", %{conn: conn, user: user} do
      user = set_password(user)

      conn =
        post(conn, ~p"/client/log-in", %{
    ...
    test "redirects to login page with invalid credentials", %{conn: conn, user: user} do
      conn =
        post(conn, ~p"/client/log-in?mode=password", %{
  ...
  describe "POST /client/log-in - magic link" do
    test "logs the user in", %{conn: conn, user: user} do
  ...
  describe "DELETE /client/log-out" do
